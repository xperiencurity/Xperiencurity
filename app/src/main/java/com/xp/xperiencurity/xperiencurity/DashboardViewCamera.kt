...
class DashboardViewCamera : AppCompatActivity() {
    ...
    private fun firebaseData() {
        ...
        firebaseRecyclerAdapter = object: FirebaseRecyclerAdapter<RemoveDeviceModel, MyViewHolder>(option) {
            ...
            override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
                val itemView = LayoutInflater.from(this@DashboardViewCamera).inflate(R.layout.dashboard_view_camera_layout,parent,false)
            ...
            override fun onBindViewHolder(holder: MyViewHolder, position: Int, model: RemoveDeviceModel) {
                ...
                listener = object: ValueEventListener {
                    override fun onCancelled(dbError: DatabaseError) {
                        Toast.makeText(this@DashboardViewCamera, "Error Occurred "+ dbError.toException(), Toast.LENGTH_SHORT).show()
                    }
